...
router.post('/updchofer/:p1,:p2,:p3,:p4,:p5,:p6', transportes.updtransporte);
router.post('/offtransporte/:p1', transportes.offtransporte);
router.post('/ontransporte/:p1', transportes.ontransporte);
