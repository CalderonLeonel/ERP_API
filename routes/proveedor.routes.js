...
router.post('/insertarConArchivo/:p1,:p2,:p3,:p4,:p5,:p6',proveedor.agregarProveedorArchivo);
router.post('/editar/:p1,:p2,:p3,:p4,:p5,:p6',proveedor.actualizarProveedor);
router.post('/editararchivo/:p1,:p2,:p3,:p4,:p5,:p6,:p7',proveedor.actualizarProveedorarchivo);
